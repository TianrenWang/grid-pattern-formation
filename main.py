...
parser.add_argument("--Np", default=512, help="number of place cells")
parser.add_argument("--Ng", default=4096, help="number of grid cells")
parser.add_argument(
    "--place_cell_rf", default=0.12, help="width of place cell center tuning curve (m)"
)
parser.add_argument(
    "--surround_scale", default=2, help="if DoG, ratio of sigma2^2 to sigma1^2"
)
...
parser.add_argument(
    "--weight_decay", default=1e-4, help="strength of weight decay on recurrent weights"
)
parser.add_argument(
...
parser.add_argument("--box_width", default=2.2, help="width of training environment")
parser.add_argument("--box_height", default=2.2, help="height of training environment")
parser.add_argument(
    "--device",
